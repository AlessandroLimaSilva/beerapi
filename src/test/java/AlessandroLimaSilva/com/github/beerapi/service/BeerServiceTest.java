...
import AlessandroLimaSilva.com.github.beerapi.exception.BeerNotFoundException;
import AlessandroLimaSilva.com.github.beerapi.exception.BeerStockExceededException;
...
public class BeerServiceTest {
    ...
    void whenBeerInformedThenItShouldBeCreated() throws BeerAlreadyRegisteredException {
        ...
        when(beerRepository.findByName(expectedBeerDTO.getName())).thenReturn(empty());
    ...
    void whenListBeerIsCalledThenReturnAListOfBeers() {
        ...
        MatcherAssert.assertThat(foundListBeersDTO, Matchers.is(Matchers.not(empty())));
        MatcherAssert.assertThat(foundListBeersDTO.get(0), Matchers.is(Matchers.equalTo(expectedFoundBeerDTO)));
    }
    ...
    void whenListBeerIsCalledThenReturnAnEmptyListOfBeers() {
        ...
        MatcherAssert.assertThat(foundListBeersDTO, Matchers.is(empty()));
    }
    ...
    void whenIncrementIsCalledWithInvalidIdThenThrowException() {
        ...
        when(beerRepository.findById(INVALID_BEER_ID)).thenReturn(empty());
